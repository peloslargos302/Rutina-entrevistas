...
for (i in seq_along(comunicacion)) {
  valor <- disposicion(comunicacion[i], diccionario = "nrc")
...
for (i in seq_along(innovacion)) {
  valor <- disposicion(innovacion[i], diccionario = "nrc")
...
for (i in seq_along(vision)) {
  valor <- disposicion(vision[i], diccionario = "nrc")
...
for (i in seq_along(compromiso)) {
  valor <- disposicion(compromiso[i], diccionario = "nrc")
...
for (i in seq_along(clima)) {
  valor <- disposicion(clima[i], diccionario = "nrc")
...
```{r graficas_afinn, include=TRUE, message=FALSE}
